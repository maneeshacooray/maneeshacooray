...
**Areas of Expertise:**
- Embedded Linux systems (Buildroot, OpenWRT, Yocto)
- Rust/C/C++ firmware for ARM & RISC-V devices
- Kernel configuration, device trees, and driver debugging
- Cloud-connected IoT systems using MQTT, ChirpStack, and Firebase
- Low-level communication: UART, I2C, SPI, and CAN
...
<img src="https://skillicons.dev/icons?i=c,cpp,rust,python,linux,raspberrypi,arduino,zig,bash,git,github,vscode&perline=8" />

</div>

---

## Hardware & Ecosystem Experience
...
- Optimizing **real-time Linux** for deterministic embedded workloads
- Building **cross-platform firmware stacks** in **Zig** and **Rust**
- Contributing to **kernel-level open source** and hardware driver projects
- Integrating **IoT telemetry** pipelines using **MQTT**, **LoRa**, and **Firebase RTDB**
- Exploring **CI/CD automation** for embedded systems
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin)](https://www.linkedin.com/in/maneesha-cooray)
[![Email](https://img.shields.io/badge/Email-Contact-orange?style=for-the-badge&logo=gmail)](mailto:maneeshacooray@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-Repos-black?style=for-the-badge&logo=github)](https://github.com/maneeshacooray?tab=repositories)
